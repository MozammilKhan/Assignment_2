...
dic1 = {"h": [["@", "A", "B"], ["@", "C"]], "d1": [["@", "A"], ["@", "B", "C"]], "d2": [["@", "C", "A"], ["@", "B"]]}
...
dic2 = {"h": [["@", "A", "B"], ["@", "C", "D", "E"], ["@", "F", "G"]], "d1": [["@", "A", "C"], ["@", "B", "D", "F"], ["@", "E", "G"]], "d2": [["@", "F", "C"], ["@", "G", "D", "A"], ["@", "E", "B"]]}
...
dic3 = {"h": [["@", "A", "B"], ["@", "C", "D", "E"], ["@", "F", "G", "H", "I"], ["@", "J", "K", "L"]], "d1": [["@", "A", "C", "F"], ["@", "B", "D", "G", "J"], ["@", "E", "H", "K"], ["I", "L"]], "d2": [["@", "J", "F"], ["@", "K", "G", "C"], ["@", "L", "H", "D", "A"], ["@", "I", "E", "B"]]}
...
dic4 = {"h": [["@", "A", "B"], ["@", "C", "D", "E"], ["@", "F", "G", "H", "I"], ["@", "J", "K", "L", "M", "N"], ["@", "O", "P", "Q", "R"]], "d1": [["@", "A", "C", "F", "J"], ["@", "B", "D", "G", "K", "O"], ["@", "E", "H", "L", "P"], ["I", "M", "Q"], ["@", "N", "R"]], "d2": []}


dic = {1: board1, 2: board2, 3: board3}
...
class Stonehenge(Game):
    ...
    def __init__(self, p1_starts):
        ...
        self.current_state = StonehengeState(p1_starts, len_game)
